...
dfx = pd.read_csv("Pays.csv", delimiter=';')  # Utiliser le fichier Pays.csv comme variables explicatives
dfy = pd.read_csv("votes_1.csv", delimiter=';')  # Utiliser le fichier votes_1.csv comme variable cible
...
# Charger les données
dfx = pd.read_csv("Pays.csv", delimiter=';')  # Variables explicatives
dfy = pd.read_csv("votes_1.csv", delimiter=';')  # Votes des députés
